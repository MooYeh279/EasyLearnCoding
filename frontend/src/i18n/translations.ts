...
const zh: Record<string, string> = {
  ...
  'topic.regenerateFailed': '重新生成',
  'topic.regenerateFailedDesc': '{count} 个课时生成失败，点击重新生成',
...
const en: Record<string, string> = {
  ...
  'topic.regenerateFailed': 'Regenerate',
  'topic.regenerateFailedDesc': '{count} lesson(s) failed, click to regenerate',
